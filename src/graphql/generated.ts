...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: {
  videoId: string; __typename?: 'Lesson', id: string, title: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null 
} | null };
